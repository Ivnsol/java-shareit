...
public class BookingCastomMapper {
    ...
    public BookingDto dtoFromBooking(Booking booking) {
        ...
        bookingDto.setItem(itemMapper.itemDtoFromItem(itemRepository.getById(booking.getItemId())));
        bookingDto.setBooker(userMapper.userDtoFromUser(userRepository.getById(booking.getBooker())));
        return bookingDto;
    }
}
